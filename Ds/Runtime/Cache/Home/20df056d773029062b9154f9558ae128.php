           ...
           <h3>修改权限组</h3>
             <div class="tab-content">
                        <div class="tab-pane active" id="horizontal-form">
                            <form class="form-horizontal" action="/admin.php/Home/AuthGroup/update/id/<?php echo ($arr["id"]); ?>" method="post">
                                <div class="form-group">
                                    <label for="focusedinput" class="col-sm-2 control-label">权限组名称</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="title" class="form-control1" id="focusedinput" placeholder="" value="<?php echo ($arr["title"]); ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <label>
                                        <?php if(is_array($rarr)): foreach($rarr as $key=>$vo): ?><input type="checkbox" name="rules[]" value="<?php echo ($vo["id"]); ?>" <?php if(in_array($vo['id'],explode(',',$arr['rules']))): ?>checked="checked"<?php endif; ?>><?php echo ($vo["title"]); ?>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; ?>
                                        </label>
                                        </div>
                                    </div>
                                </div>
