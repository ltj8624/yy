	...
	<div id="pageAll">
		...
		<div class="userS showList">
			...
			<div class="connoisseur">
				...
				<!-- user 表格 显示 -->
				<div class="conShow">
					<form action="/admin.php/Home/Wt/save" method="post" enctype="multipart/form-data">
    					<input type="hidden" name="id" value="<?php echo ($id); ?>"/>
						<table border="1" class="xianwei" width="100%">
						<tr>
							<td class="tdColor">问题</td>
						</tr>
						<tr height="40px">
				
							<td><input type="text" name="wt" value="<?php echo ($wt); ?>" /></td>
						</tr>
						<tr>
							<td class="tdColor">回答</td>
						</tr>
						<tr>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Wt/tokendel/id/'+del);
	$(".banDel").show();
});
// 广告弹出框
$(".delban").click(function(){
