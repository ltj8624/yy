	...
	<div id="pageAll">
		...
		<div class="userS showList">
			...
			<div class="connoisseur">
				...
				<!-- user 表格 显示 -->
				<div class="conShow">
					<form action="/admin.php/Home/ProductPhoto/save" method="post" enctype="multipart/form-data">
						...
						<tr height="40px">
							<td><input type="file" name="photo" value="<?php echo ($photo); ?>"/><img src="/Public/<?php echo ($photo); ?>"></td>
						</tr>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/ProductPhoto/tokendel/id/'+del);
	$(".banDel").show();
});
// 广告弹出框
$(".delban").click(function(){
