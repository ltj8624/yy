	...
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
					<form action="/admin.php/Home/Video/indexd">
						<div class="cfD">
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="tdColor">羊舍名称</td>
							<td class="tdColor">羊舍图片</td>
							
							<td class="tdColor">操作&nbsp;&nbsp;&nbsp;
							<a href="/admin.php/Home/Video/dadd">添加</a>
						...
						<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="40px">
							...
							<td>
								<a href="<?php echo U('Home/Video/saved',array('id'=>$v['id']));?>" >修改</a>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Video/dele/id/'+del);
    $(".banDel").show();
});
