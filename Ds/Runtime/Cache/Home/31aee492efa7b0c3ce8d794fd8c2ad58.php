				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="tdColor">推送消息</td>
							
							<td class="tdColor">时间</td>
							<td class="tdColor">操作&nbsp;&nbsp;&nbsp;
							<a href="/admin.php/Home/Infomation/add">添加</a>
							</td>
						</tr>
						...
						<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="40px">
							...
							<td>
								<a href="<?php echo U('Home/Infomation/save',array('id'=>$v['id']));?>" >修改</a>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Infomation/delete/id/'+del);
    $(".banDel").show();
});
