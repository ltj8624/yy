	...
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
					<form action="/admin.php/Home/Order/index">
						<div class="cfD">
							<input class="userinput" name="buyer_name" type="text" placeholder="输入会员名" />&nbsp;&nbsp;&nbsp;
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="tdColor">会员名称</td>
							<td class="tdColor">手机号</td>
							<td class="tdColor">产品名称</td>
							<td class="tdColor">购买日期</td>
							<td class="tdColor">到期日期</td>
							<td class="tdColor">总周期</td>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Order/delete/gid/'+del);
    $(".banDel").show();
});
