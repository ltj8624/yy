				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="tdColor">商城轮播图</td>
							
							<td class="tdColor">操作&nbsp;&nbsp;&nbsp;
							<a href="/admin.php/Home/Lbt/add">添加</a>
							</td>
						</tr>
						...
						<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="40px">
							...
							<td>
								<a href="<?php echo U('Home/Lbt/save',array('bid'=>$v['bid']));?>" >修改</a>
								
								<a class="delban" style="cursor:pointer;" value="<?php echo ($v["bid"]); ?>">删除</a>
							</td>
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Lbt/delete/bid/'+del);
    $(".banDel").show();
});
