...
<div class="top">
  ...
  <h1><span>第一期</span></h1>-->
  <a href="javascript:history.go(-1);"><img src="/Public/img/jiantou.png" /></a>牧人中心-修改账号密码
</div>
<div class="zc huibg">
  <ul>
  <form action="/index.php/Qt/User/xgmm" method="post">
    ...
    <li><span>账号密码：</span><input name="pwd" type="password"  class="text"/></li>
