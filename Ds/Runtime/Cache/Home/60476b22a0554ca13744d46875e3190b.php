	...
	<div id="pageAll">
		...
		<div class="userS showList">
			...
			<div class="connoisseur">
				...
				<!-- user 表格 显示 -->
				<div class="conShow">
					<form action="/admin.php/Home/Kf/save" method="post" enctype="multipart/form-data">
						...
						<tr height="40px">
							<td><input type="text" name="wx" value="<?php echo ($wx); ?>" /></td>
						</tr>
						<tr>
							<td class="tdColor">QQ</td>
						</tr>
						<tr height="40px">
...
$(".delban").click(function(){
	...
	$('.yes').attr('href','/admin.php/Home/Kf/tokendel/id/'+del);
	$(".banDel").show();
});
// 广告弹出框
$(".delban").click(function(){
