	...
	<div id="pageAll">
		...
		<div class="page">
			...
			<div class="connoisseur">
				<div class="conform">
					<form action="/admin.php/Home/News/zx">
						<div class="cfD">
							<input class="userinput" name="name" type="text" placeholder="输入标题" />&nbsp;&nbsp;&nbsp;
				...
				<div class="conShow">
					<table border="1" cellspacing="0" cellpadding="0" width="100%">
						<tr>
							...
							<td class="tdColor" width="100px">操作&nbsp;&nbsp;&nbsp;
							<a href="<?php echo U('Home/News/zxadd');?>">添加</a>
							</td>
						</tr>
						...
						<?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr height="40px">
							<td><?php echo ($v['id']); ?></td>
							<td style="width:29%; height:75px;"><?php echo ($v['name']); ?></td>
							<td style="width:29%;"><?php echo (substr($v["page"],0,60)); ?>...</td>
							<td style="width:29%;"><img width="150px" height="75px" src="/Public/<?php echo ($v['photo']); ?>"></td>
							
							<td>
								<a href="<?php echo U('Home/News/zxsave',array('id'=>$v['id']));?>" >修改</a>
